...
const PageNotFound = () => {
  return (
    <div className="p-10 relative flex flex-col max-w-xl mx-auto items-top justify-center min-h-[400px] bg-white sm:pt-0 dark:dark:bg-gray-950 dark:text-white">
